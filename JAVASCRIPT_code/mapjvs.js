...
const marker2 = L.marker([28.2180, 94.7278], { icon: icon2 });
const marker3 = L.marker([26.2006, 89.9376], { icon: icon3 });
const marker4 = L.marker([26.0961, 85.3131], { icon: icon4 });
const marker5 = L.marker([22.2587, 71.1924], { icon: icon5 });
const marker6 = L.marker([34.6048, 76.1734], { icon: icon6 });
const marker7 = L.marker([15.3173, 75.7139], { icon: icon7 });
const marker8 = L.marker([22.9734, 78.6569], { icon: icon8 });
const marker9 = L.marker([19.7515, 75.7139], { icon: icon9 });
const marker10 = L.marker([24.6637, 93.9063], { icon: icon10 });
const marker11 = L.marker([20.0451, 83.0985], { icon: icon11 });
const marker12 = L.marker([30.9471, 76.3412], { icon: icon12 });
const marker13 = L.marker([27.0238, 74.2179], { icon: icon13 });
const marker14 = L.marker([11.1271, 78.6569], { icon: icon14 });
const marker15 = L.marker([27.8467, 80.9462], { icon: icon15 });
const marker16 = L.marker([22.9868, 87.8550], { icon: icon16 });
...
function generateList(){
  ...
  culturelist.forEach((state) => { 
    ...
    a.href = '#';
    a.innerText = state.properties.origin;
